              ...
              <div className="flex flex-1 flex-col">
                ...
                <div className="mt-3 flex gap-2">
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-1.5 rounded-md bg-cyan-600 px-2 py-1.5 text-xs font-semibold text-white transition hover:bg-cyan-700"
                  >
